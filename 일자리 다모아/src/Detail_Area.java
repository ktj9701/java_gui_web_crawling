...
public class Detail_Area {
	...
	// 경기도
	static String[] 경기 = { "전체", "가평군", "고양시 덕약구", "고양시 일산동구", "고양시 일산서구", "과천시", "광명시", "광주시", "구리시",
	...
	// 인천
	static String[] 인천 = { "전체", "강화군", "계양구", "남동구", "동구", "미추홀구", "부평구", "서구", "연수구", "옹진군", "중구" };
	...
	// 대전
	static String[] 대전 = { "전체", "대덕구", "동구", "서구", "유성구", "중구" };
	...
	// 부산
	static String[] 부산 = { "전체", "강서구", "금정구", "기장군", "남구", "동구", "동래구", "부산진구", "북구", "사상구", "시하구", "서구",
			"수영구", "연제구", "영도구", "중구", "해운대구" };

	// 울산
	static String[] 울산 = { "전체", "남구", "동구", "북구", "울주군", "중구" };

	// 경남
	static String[] 경남 = { "전체", "거제시", "거창군", "고성군", "김해시", "남해군", "밀양시", "사천시", "산청군", "양산시", "의령군",
